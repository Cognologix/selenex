package com.cadent.test.page.pagefactory;
...
public  class DynamicPageFactory {
    ...
    private static Field declaredAnnotationsField;

    static {
        try {
            method = Field.class.getDeclaredMethod(DECLARED_ANNOTATIONS);
            method.setAccessible(true);
            declaredAnnotationsField = Field.class.getDeclaredField(DECLARED_ANNOTATIONS);
    ...
    public void updateLocator(Object page, String fieldName, Object... args) {
        try {
            ...
            Map<Class<? extends Annotation>, Annotation> declaredAnnotations =
                    (Map<Class<? extends Annotation>, Annotation>) declaredAnnotationsField.get(field);
